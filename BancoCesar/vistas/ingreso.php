...
<?php
                     ...
                     if(count($resultado)>0){
                       foreach ($resultado as $registro ) {
                         ?>
      <h2 class="text-center mt-3 text-white">Su depósito es: $<?php echo $registro['ingresos']; ?> </h2> 
      </div>
      <?php
                       }
                      }
      ...
      <div class="row pt-5">
                ...
                <a href="formDepo.php?id=<?php echo $registro['nip']; ?>" class="btn btn-dark" style="width: 120px;">Ingresar depósito</a>
                </div>
                </div>
      </div>

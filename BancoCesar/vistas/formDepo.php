...
<input type="text" class="form-control" name="ingreso" id="floatingInput" placeholder="Ingresar" style="width: 200px;">                      
<br>

<button type="submit" class="btn btn-dark" style="width: 100px;">Ingresar depósito</button>
<a href="ingreso.php" class="btn btn-dark" style="width: 100px;">Volver</a>
</form> 
</div>  
</body>
</html> 
...
<?php
                     ...
                     if(count($resultado)>0){
                       foreach ($resultado as $registro ) {
                         ?>
      <h2 class="text-center mt-3 text-white">Su retiro es: $<?php echo $registro['egresos']; ?> </h2> 
      </div>
      <?php
                       }
                      }
      ...
      <div class="row pt-5">
                ...
                <a href="formRetiro.php?id=<?php echo $registro['nip']; ?>" class="btn btn-dark" style="width: 120px;">Ingresar retiro</a>
                </div>
                </div>
      </div>
